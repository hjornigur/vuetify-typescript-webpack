 ...
 */
export class ESI<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    v1 = {
        /**
    ...
    v5 = {
        /**
         * @description Public information about a character --- This route is cached for up to 86400 seconds
         *
         * @tags Character
